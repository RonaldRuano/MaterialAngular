...
export interface TablaEstudianteItem {
  'id': string,
  'id_persona': string,
  'nombre': string,
  'apellido': string,
...
const EXAMPLE_DATA: TablaEstudianteItem[] = [];

/**
 * Data source for the TablaEstudiante view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class TablaEstudianteDataSource extends DataSource<TablaEstudianteItem> {
  data: TablaEstudianteItem[] = [];
   ...
   */
  connect(): Observable<TablaEstudianteItem[]> {
   ...
   */
  private getPagedData(data: TablaEstudianteItem[]): TablaEstudianteItem[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TablaEstudianteItem[]): TablaEstudianteItem[] {
